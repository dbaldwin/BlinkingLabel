...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/dbaldwin/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dbaldwin' => 'dennisbaldwin@gmail.com' }
  s.source           = { :git => 'https://github.com/dbaldwin/BlinkingLabel.git', :tag => s.version.to_s }
